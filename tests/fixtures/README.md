...
- `known-win-x86.exe` — deterministic minimal PE32 executable fixture with `.text`,
  `.reloc`, and `.debug` sections, one HIGHLOW base relocation, one CodeView RSDS
  debug record, and `IMAGE_FILE_MACHINE_I386`.
- `known-win-x64.exe` — deterministic minimal PE32+ executable fixture with a
  ...
  CodeView RSDS debug record, and `IMAGE_FILE_MACHINE_AMD64`.
